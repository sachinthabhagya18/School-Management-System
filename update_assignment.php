...
?>
  ...
  <head>
    ...
    <title>EASB Teacher | Update Assignment </title>
    <!-- plugins:css -->
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" id="a_name" placeholder="Assignment" value="<?php echo $product["a_name"]  ?>">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Assignment Id</label>
                    <input type="text" class="form-control" id="a_unic_id" placeholder="Assignment Unicode" value="<?php echo $product["a_unic_id"]  ?>">
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Assignment Release Date</label>
                    <input type="date" class="form-control" id="a_release_date" value="<?php echo $product["a_release_date"]  ?>">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Assignment End Date</label>
                    <input type="date" class="form-control" id="a_end_date" value="<?php echo $product["a_end_date"]  ?>">
                  </div>
                </div>
               <div class="row">
                  <div class="form-group col-12">
                    <label for="exampleInputEmail3">Add Assignment File </label>
                    <input class="form-control" type="file" id="l_file" value="<?php echo $product["a_location"]  ?>" disabled/>
                    <p class="text-danger"><b> * You Can't Update File So You can delete THis file and Re-upload</b></p>
                  </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary me-2" onclick="updateassignment(<?php echo $product['a_id'] ?>);">Update Assignment</button>
