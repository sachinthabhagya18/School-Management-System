...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Update Teacher</title>
    <!-- plugins:css -->
        ...
        <div class="row">
          <div class="col-10   mt-3 grid-margin stretch-card">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                <h4 class="card-title">Update Teacher Profile</h4>
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="email" class="form-control" id="tcode" placeholder="NIC" value="<?php echo $product["t_code"]  ?>">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputPassword4">Password</label>
                    <input type="password" class="form-control" id="password" placeholder="Password" value="<?php echo $product["t_password"]  ?>">
                  </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary me-2" onclick='updateteacher(<?php echo $product["t_id"] ?>);'>Update teacher</button>
