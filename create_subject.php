...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Create Subject</title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row">
          <div class="col-lg-8 col-10 mx-lg-0 mx-2 mt-3 grid-margin ">
            <div class="card">
              <div class="card-body">
          ...
          <div class="col-md-4 col-10 mx-lg-0 mx-2 mt-3 grid-margin ">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Create Subject</h4>
                <p class="card-description">
                  Fill form & Add Subject
                </p>
                <form class="forms-sample">
                  ...
                  <div class="form-group">
                    <label for="exampleInputConfirmPassword1">Subject Code</label>
                    <input type="text" class="form-control" id="subjectcode" placeholder="Subject Code">
                  </div>
                  <button type="submit" class="btn btn-primary me-2" onclick="addsubject();">Add Subject</button>
                </form>
              </div>
            </div>
          </div>
