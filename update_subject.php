...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Update Subject</title>
    <!-- plugins:css -->
            ...
            <div class="card-body">
              ...
              <form class="forms-sample">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="subjectname" value="<?php echo $product["subjectname"]  ?>" placeholder="Batch Name">
                </div>
                <div class="form-group">
                  <label for="exampleInputUsername1">Subject Code</label>
                  <input type="text" class="form-control" id="subjectcode" value="<?php echo $product["subjectcode"]  ?>" placeholder="Batch Name">
                </div>


                <button type="submit" class="btn btn-primary me-2" onclick='updatesubject(<?php echo $product["id"] ?>);'>Update Batch</button>
              </form>
            </div>
          </div>
        </div>
