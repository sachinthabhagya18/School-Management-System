                ...
                <div class="col-6">
                  <div class="row">
                    <div class="col-3 d-inline-block d-grid">
                      <select class="btn btn-sm  btn-outline-primary" id="basic_search_subject2">
                    ...
                    <div class="col-2 d-inline-block d-grid">
                      <button class="btn btn-sm btn-dark mt-1" onclick="basicSearch2();">Search</button>
       
                    </div>
                    <div class="col-1 d-inline-block d-grid">
                    <button class="btn btn-sm btn-dark mt-1" onclick="refresh2();">Refresh</button>
                    </div>
