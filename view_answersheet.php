    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-10  mx-1 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Student Answear Sheets</h4>
              <div class="row offset-1">
                <div class="col-10">
                  <input type="text" class="form-control" id="searchtext" onkeyup="searchUser();" placeholder="Please type student NIC to search......" />
                </div>
