...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Add Lesson</title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row">
          <div class="col-10 mx-1  mt-2 grid-margin stretch-card">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                <h4 class="card-title">Add Lesson Note</h4>
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Lesson Note Name</label>
                    <input type="text" class="form-control" id="l_name" placeholder="Lesson Note">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Lesson Note Id</label>
                    <input type="text" class="form-control" id="l_id" placeholder="Lesson Id">
                  </div>
                </div>
               <div class="row">
                  <div class="form-group col-12">
                    <label for="exampleInputEmail3">Add lesson File</label>
                    <input class="form-control" type="file"  id="l_file" required/>
                  </div>
                </div> 
                ...
                <button type="submit" class="btn btn-primary me-2" onclick="addlessonnote();">Add Lesson note</button>
