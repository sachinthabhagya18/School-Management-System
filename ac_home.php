            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                  ...
                  <a href="ac_updateprofile.php" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i>Update Profile</a>
                  ...
                  <div class="tab-content tab-content-basic">
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
                              ...
                              <div class="card card-rounded table-darkBGImg">
                                <div class="card-body">
                                  <div class="col-sm-8">
                                    ...
                                    <a href="add_student.php" class="btn btn-info upgrade-btn">Add Student</a>
                                    <a href="manage_student.php" class="btn btn-info upgrade-btn">Manage Student</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div class="card bg-primary card-rounded">
                                <div class="card-body pb-0">
                                  ...
                                  <div class="row text-center">
                                    <div class="col-sm-6">
                                      <label class="status-summary-ight-white mb-2">*Manage Student</label>
                                    </div>
                                    <div class="col-sm-6">
                                      <label class="status-summary-ight-white mb-2">*Release Results</label>
                                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-12  mx-1 mt-3 grid-margin stretch-card">
                          <div class="card">
                            <div class="card-body">
