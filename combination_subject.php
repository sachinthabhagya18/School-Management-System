...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Subject Combination</title>
    <!-- plugins:css -->
...
<div class="row">
<div class="col-lg-8 col-10 mx-lg-0 mx-1 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><button class="badge badge-warning">Edit</button></td>
                      </tr>
                    <?php
                    }
                    ?>
        ...
        <div class="col-md-4 col-10 mx-lg-0 mx-1 mt-3 grid-margin ">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample">
                ...
                <div class="form-group">
                  <label for="exampleInputConfirmPassword1">Combination</label>
                  <select type="text" class="form-control" id="exampleInputConfirmPassword1" placeholder="Section">
                    <option value="">1</option>
                    <option value="">1</option>
                  </select>
                </div>
                <button type="submit" class="btn btn-primary me-2">Add Subject Combination</button>
              </form>
            </div>
          </div>
        </div>
