        ...
        <div class="row">
          <div class="col-10 mx-lg-5  mt-3 grid-margin stretch-card">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                <h4 class="card-title">Create  Academic Officer Profile</h4>
                ...
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputEmail3">Academic Officer Code</label>
                    <input type="email" class="form-control" id="accode" placeholder="Academic Officer Code">
                  </div>
                  <div class="form-group col-6">
                ...
                <button type="submit" class="btn btn-primary me-2" onclick="addac_officer();">Add Academic Officer
                </button>
