...
session_start();
// $ac_id=$_SESSION["t"]["ac_id"];
// $batch_id = $_SESSION["ac"]["batch_id"];
...
if (isset($_SESSION["ac"])) {
  ...
  INNER JOIN assignment ON assignment.a_id = marks.assignment_a_id ");
...
?>
  ...
  <head>
    ...
    <title>EASB AO | Assignment Results</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-10 mx-1 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">All Student Result</h4>
              <div class="table-responsive text-center">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $ir["s_fname"] . " " . $ir["s_lname"] ?><br><?php echo $ir["s_nic"] ?></td>
                        <td><?php echo $ir["subjectname"] ?></td>
                        <td><?php echo $ir["a_unic_id"] ?></td>
                        <td class="text-danger"><b><?php echo $ir["marks"] ?></b></td>
                        <td><button class="badge badge-info" onclick="sendemailid2(<?php echo $ir['a_id'] ?>);">Release marks</button> </td>
                      </tr>
