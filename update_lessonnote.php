...
?>
  ...
  <head>
    ...
    <title>EASB Teacher | Update Lesson </title>
    <!-- plugins:css -->
        ...
        <div class="row">
          <div class="col-10  mt-3 grid-margin stretch-card">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                <h4 class="card-title">Update Lesson Note</h4>
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Lesson Note Name</label>
                    <input type="text" class="form-control" id="l_name" placeholder="Lesson Note" value="<?php echo $product["l_name"]  ?>">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Lesson Note Id</label>
                    <input type="text" class="form-control" id="l_id" placeholder="Lesson Id" value="<?php echo $product["l_id"]  ?>">
                  </div>
                </div>
               <div class="row">
                  <div class="form-group col-12">
                    <label for="exampleInputEmail3">Add lesson File</label>
                    <input class="form-control" value="<?php echo $product["l_location"]  ?>" type="file"  id="l_file"  disabled/>
                ...
                <button type="submit" class="btn btn-primary me-2" onclick="updatelessonnote(<?php echo $product['lid'] ?>);">Update Lesson note</button>
