...
?>
  ...
  <head>
    ...
    <title>EASB Student | Upload Answer </title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-md-3 mx-3 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Upload Assignment Answear</h4>
              <form class="forms-sample">
                <div class="form-group">
                  <label for="exampleInputUsername1">Student NIC</label>
                  <input type="text" class="form-control" id="s_nic" value="<?php echo $product["s_nic"]  ?>" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputUsername1">Assignment Code</label>
                  <input type="text" class="form-control" id="a_id" value="<?php echo $product["a_id"]  ?>" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputUsername1">Subject Code</label>
                  <input type="text" class="form-control" id="subjectcode" value="<?php echo $product["subjectcode"]  ?>" disabled>
                </div>
                <div class="form-group">
                <h6 class="text-danger"> * Please Select Pdf File For Your Answer </h6>
                <!-- <input class="form-control" type="file"  id="l_file" /> -->
                  <input class="d-none" type="file" id="l_file" aria-label="file example" required/>
                  <label class="btn btn-info me-1" for="l_file">Upload</label>

                </div>
                
                <button class="btn btn-primary me-2" onclick="uploadans();">Upload Assignment Answear</button>
              </form>
            </div>
          </div>
        </div>
