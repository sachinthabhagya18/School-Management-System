...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Reg Teachers</title>
    <!-- plugins:css -->
          ...
          <div class="col-10 mx-1  mt-3 grid-margin stretch-card">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputEmail3">Teacher Code</label>
                    <input type="email" class="form-control" id="tcode" placeholder="Teacher Code" >
                  </div>
                  <div class="form-group col-6">
                ...
                <div class="form-group">
                  ...
                  <option value="0">Select subject</option>
                                        ...
                                        $rs1 = Database::search("SELECT * FROM `subject`");
                                        $n1 = $rs1->num_rows;
                ...
                <button type="submit" class="btn btn-primary me-2" onclick="addteacher();">Add teacher</button>
