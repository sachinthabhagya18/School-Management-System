...
?>
  ...
  <head>
    ...
    <title>EASB Student | Update Profile </title>
    <!-- plugins:css -->
            ...
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                ...
                <div class="form-group">
                  <img class="col-6 col-lg-4 ms-2 img-thumbnail" id="prev" src="<?php echo $product["s_img"] ?>" />
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="email" class="form-control" id="nic" placeholder="NIC" value="<?php echo $product["s_nic"]  ?>" disabled>
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputPassword4">Password</label>
                    <input type="password" class="form-control" id="password" placeholder="Password" value="<?php echo $product["s_password"]  ?> " disabled>
                  </div>
                </div>
                <div class="form-group">
