                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="statistics-details d-flex align-items-center justify-content-between">
                            <div>
                              <?php
                              $count1 = Database::search("SELECT * FROM `admin`");
                              $c1 = $count1->num_rows;
                              ?>
                              <p class="statistics-title">Total Admins</p>
                              <h3 class="rate-percentage text-danger"><b>0<?php echo $c1; ?></b></h3>
                            </div>
                            <div>
                              <?php
                              ...
                              <div class="card card-rounded table-darkBGImg">
                                <div class="card-body">
                                  <div class="col-sm-8">
                                    ...
                                    <a href="add_acofficer.php" class="btn btn-info upgrade-btn">Add Academic Officer</a>
                                    <a href="add_teacher.php" class="btn btn-info upgrade-btn">Add Teacher</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                              <div class="card bg-primary card-rounded">
                                <div class="card-body pb-0">
                                  <h4 class="card-title card-title-dash text-white mb-4">Admin Panel Activites</h4>
                                  <div class="row text-center">
                                    <div class="col-sm-6">
                                      <label class="status-summary-ight-white mb-2">*Manage Teachers</label>

                                      <label class="status-summary-ight-white mb-2">*Manage Officers</label>
                                    </div>
                                    <div class="col-sm-6">
                                      <label class="status-summary-ight-white mb-2">*Manage Subject</label>

                                      <label class="status-summary-ight-white mb-2">*Manage Batch</label>
                                    </div>
                              ...
                              <div class="card card-rounded">
                                <div class="card-body">
                                  <div class="d-sm-flex justify-content-between align-items-start">
                                    ...
                                    <div>
                                      <a href="add_teacher.php" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button"><i class="mdi mdi-account-plus"></i>Add new member</a>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-12">
                                      <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div>
                                          <h4 class="card-title card-title-dash">Acadamic Officer</h4>
                                        </div>
                                      </div>
                                      <div class="mt-3">
                                        <?php
                                        $invoicers2 = Database::search("SELECT * FROM `ac_officer` ");
                                        ...
                                        ?>
                                          <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                            <div class="d-flex">
                                              <img class="img-sm rounded-10" src="<?php echo $ir2["ac_img"] ?>" alt="profile">
                                              <div class="wrapper ms-3">
                                                <p class="ms-1 mb-1 fw-bold"><?php echo $ir2["ac_fname"] . " " . $ir2["ac_lname"] ?></p>
                                                <small class="text-muted mb-0"><?php echo $ir2["ac_code"] ?></small>
                                              </div>
                                            </div>
