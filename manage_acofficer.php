...
if (isset($_SESSION["u"])) {
  ...
  $invoicers = Database::search("SELECT * FROM  `ac_officer`; ");
...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Manage AO </title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-10 mx-1  mx-3 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Manage  Academic Officer</h4>
              <div class="table-responsive text-center">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $ir["ac_fname"] . " " . $ir["ac_lname"] ?></td>
                        <td><?php echo $ir["ac_email"] ?></td>
                        <td><?php echo $ir["ac_code"] ?></td>
                        <td><?php echo $ir["ac_mobile"] ?></td>

                 


                        <td><button class="badge badge-warning" onclick="sendid(<?php echo $ir['ac_id'] ?>);">Edit</button> |
                        <button class="badge badge-info" onclick="sendemailid3(<?php echo $ir['ac_id'] ?>);">Send Request</button> |
                          <button class="badge badge-danger" onclick="deletemodel(<?php echo $ir['ac_id'] ?>);">Delete</button>
                        </td>

                      </tr>
                      <div class="modal fade" id="deleteModel<?php echo $ir['ac_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-danger" onclick="deleteac_officer(<?php echo $ir['ac_id'] ?>);">Yes</button>
                            </div>
                          </div>
                        </div>
                      </div>
