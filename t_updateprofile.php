...
?>
  ...
  <head>
    ...
    <title>EASB Teacher | Update Profile </title>
    <!-- plugins:css -->
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" id="fname" placeholder="First Name" value="<?php echo $product["t_fname"]  ?>">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Last Name</label>
                    <input type="text" class="form-control" id="lname" placeholder="Last Name" value="<?php echo $product["t_lname"]  ?>">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group col-12">
                    ...
                    <input type="email" class="form-control" id="email" placeholder="Email" value="<?php echo $product["t_email"]  ?>">
                  </div>
                  <div class="form-group col-12">
                    <label for="exampleInputEmail3">Mobile</label>
                    <input type="email" class="form-control" id="mobile" placeholder="Mobile" value="<?php echo $product["t_mobile"]  ?>">
                  </div>
                </div>
                <div class="form-group">
                  <img class="col-6 col-lg-4 ms-2 img-thumbnail" id="prev" src="<?php echo $product["t_img"] ?>" />
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="email" class="form-control" id="nic" placeholder="NIC" value="<?php echo $product["t_code"]  ?>" disabled>
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputPassword4">Password</label>
                    <input type="password" class="form-control" id="password" placeholder="Password" value="<?php echo $product["t_password"]  ?> " disabled>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="batch" disabled>

                    <?php
                    $rss2 = Database::search("SELECT * FROM `subject` WHERE `id`='" . $product["subject_id"] . "'  ");
                    $brand = $rss2->fetch_assoc();
                    ?>
                    <option value="<?php echo $brand["id"] ?>"><?php echo $brand["subjectname"] ?></option>
                    <?php
                    $rss3 = Database::search("SELECT * FROM `subject` WHERE `id`!='" . $product["subject_id"] . "'  ");
                    $n3 = $rss3->num_rows;

                    for ($i = 1; $i <= $n3; $i++) {
                      $mod = $rss3->fetch_assoc();
                    ?>
                      <option value="<?php echo $mod["id"] ?>"><?php echo $mod["subjectname"] ?></option>
                    <?php
                    }
                    ?>
                  </select>
