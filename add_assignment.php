...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Add Assignment</title>
    <!-- plugins:css -->
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" id="a_name" placeholder="Assignment">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Assignment Id</label>
                    <input type="text" class="form-control" id="a_unic_id" placeholder="Assignment Unicode">
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputName1">Assignment Release Date</label>
                    <input type="date" class="form-control" id="a_release_date">
                  </div>
                  <div class="form-group col-6">
                ...
                <div class="row">
                  <div class="form-group col-12">
                    <label for="exampleInputEmail3">Add lesson File</label>
                ...
                <button type="submit" class="btn btn-primary me-2" onclick="addassignment();">Add Assignment</button>
