...
if (isset($_SESSION["t"])) {
  ...
  INNER JOIN assignment ON assignment.a_id = marks.assignment_a_id WHERE subject.id = '".$subject_id."'");
...
?>
  ...
  <head>
    ...
    <title>EASB Teacher | Marks </title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-10  mx-1 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Added Marks Students</h4>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $ir["marks"] ?></td>


                        <td><button class="badge badge-warning" onclick="sendid3(<?php echo $ir['m_id'] ?>);">Edit</button> |
                          <button class="badge badge-danger" onclick="deletemodel3(<?php echo $ir['m_id'] ?>);">Delete</button>
                        </td>

                      </tr>
                      <div class="modal fade" id="deleteModel<?php echo $ir['m_id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-danger" onclick="deleteMarks(<?php echo $ir['m_id'] ?>);">Yes</button>
                            </div>
                          </div>
                        </div>
                      </div>
