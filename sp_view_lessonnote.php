...
session_start();
// $t_id=$_SESSION["s"]["s_id"];
$batch = $_SESSION["s"]["batch_id"];

if (isset($_SESSION["s"])) {

  $invoicers = Database::search("SELECT * FROM lessonnote INNER JOIN teacher ON lessonnote.teacher_t_id=teacher.t_id WHERE lessonnote.batch_id = '" . $batch . "'");
...
?>
  ...
  <head>
    ...
    <title>EASB Student | Lesson </title>
    <!-- plugins:css -->
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td> <button class="badge badge-primary" onclick="location.href='<?php echo $ir['l_location'] ?>'">Download</button></td>
