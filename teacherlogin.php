...
<head>
  ...
  <title>EASB Teacher | Login </title>
  <!-- plugins:css -->
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto text-center">
            ...
            <div class="brand-logo">
              ...
              <h4>Hello! let's get Teacher Login</h4>
              ...
              <p class="text-danger" id="msg2"></p>
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" onclick="signInteacher();">SIGN IN</a>
                </div>
                <div class="my-2 d-flex justify-content-between align-items-center offset-4">
