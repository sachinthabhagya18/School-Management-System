...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Update AO </title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row">
          <div class="col-12   mt-3 grid-margin stretch-card">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                <h4 class="card-title">Update  Academic Officer Profile</h4>
                <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-6">
                    <label for="exampleInputEmail3">Acadamic officer Code</label>
                    <input type="email" class="form-control" id="accode" placeholder="Acadamic officer Code" value="<?php echo $product["ac_code"]  ?>">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputPassword4">Password</label>
                    <input type="password" class="form-control" id="password" placeholder="Password" value="<?php echo $product["ac_password"]  ?>">
                  </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary me-2" onclick='updateac_officer(<?php echo $product["ac_id"] ?>);'>Update Acadamic officer</button>
