...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Update Batch </title>
    <!-- plugins:css -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-lg-6 mx-3 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Manage Batch</h4>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><button class="badge badge-warning" onclick="sendid(<?php echo $ir['id'] ?>);">Edit</button> |
                          <button class="badge badge-danger" onclick="deletemodel(<?php echo $ir['id'] ?>);">Delete</button>
                        </td>
                      </tr>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-danger" onclick="deletebatch(<?php echo $ir['id'] ?>);">Yes</button>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="card-body">
              ...
              <form class="forms-sample">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="batchname" value="<?php echo $product["batchname"]  ?>" placeholder="Batch Name">
                </div>
                <div class="form-group">
                  <img class="col-8 col-lg-4 ms-2 img-thumbnail" id="prev" src="<?php echo $product["batchimg"] ?>" />
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="section" disabled>
                    <?php
                    $rss2 = Database::search("SELECT * FROM `section` WHERE `s_id`='" . $product["section_s_id"] . "'  ");
                    $brand = $rss2->fetch_assoc();
                    ?>
                    <option value="<?php echo $brand["s_id"] ?>"><?php echo $brand["s_name"] ?></option>
                    <?php
                    $rss3 = Database::search("SELECT * FROM `section` WHERE `s_id`!='" . $product["section_s_id"] . "'  ");
                    $n3 = $rss3->num_rows;

                    for ($i = 1; $i <= $n3; $i++) {
                      $mod = $rss3->fetch_assoc();
                    ?>
                      <option value="<?php echo $mod["s_id"] ?>"><?php echo $mod["s_name"] ?></option>
                    <?php
                    }
                    ?>
                  </select>
                </div>
                <button type="submit" class="btn btn-primary me-2" onclick='updatebatch(<?php echo $product["id"] ?>);'>Update Batch</button>
              </form>
            </div>
          </div>
        </div>
