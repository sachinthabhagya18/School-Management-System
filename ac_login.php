      ...
      <div class="content-wrapper d-flex align-items-center auth px-0">
        <div class="row w-100 mx-0">
          ...
          <div class="auth-form-light text-left py-5 px-4 px-sm-5 text-center">
              ...
              <h4>Hello! let's get Accadamic Officer Login</h4>
              ...
              <p class="text-danger" id="msg2"></p>
                ...
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="email" placeholder="Email" value="<?php echo $e; ?>">
                </div>
                <div class="form-group">
