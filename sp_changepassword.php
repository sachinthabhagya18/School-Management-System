...
?>
  ...
  <head>
    ...
    <title>EASB Student | Change Password </title>
    <!-- plugins:css -->
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <div class="form-group col-12">
                    <label class="text-primary ts  mx-5" ><b><?php echo $s["s_fname"] . " " . $s["s_lname"] ?></b></label>
                    <label class="text-info ts mx-5" ><b><?php echo $product["s_nic"]  ?></b></label>
                </div>
