...
if (isset($_SESSION["t"])) {
  ...
  $invoicers = Database::search("SELECT * FROM lessonnote INNER JOIN teacher ON lessonnote.teacher_t_id = teacher.t_id INNER JOIN batch ON lessonnote.batch_id=batch.id
...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Manage Lesson </title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-10  mx-1 mt-3 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Manage Lesson Note</h4>
              <div class="table-responsive text-center">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <td><?php echo $ir["l_name"] ?></td>
                        <td><?php echo $ir["l_id"] ?></td>
                        <td><?php echo $ir["batchname"] ?></td>
                        <td><?php echo $ir["l_adddate"] ?></td>
                        <td>

                          
                              <button class="badge badge-primary" onclick="location.href='<?php echo $ir['l_location'] ?>'">View Lesson File</button>
                      
                          <!-- <a href="<?php echo $ir["l_location"] ?>" download=""></a>
                 <input  type="button" value="Download Lesson"> -->
                      </td>


                        <td><button class="badge badge-warning" onclick="sendid(<?php echo $ir['lid'] ?>);">Edit</button> |
                          <button class="badge badge-danger" onclick="deletemodel(<?php echo $ir['lid'] ?>);">Delete</button>
                        </td>

                      </tr>
                      <div class="modal fade" id="deleteModel<?php echo $ir['lid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-danger" onclick="deletelessonnote(<?php echo $ir['lid'] ?>);">Yes</button>
                            </div>
                          </div>
                        </div>
                      </div>
