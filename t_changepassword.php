...
?>
  ...
  <head>
    ...
    <title>EASB Teacher | Change Password </title>
    <!-- plugins:css -->
  ...
  <body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="row">
          <div class="col-10   mt-3 grid-margin">
            <div class="card mx-lg-5 mx-sm-5">
              <div class="card-body ">
                <h4 class="card-title">Update Password</h4>
                <div class="row">
                  <div class="form-group col-12">
                  <span>Teacher Name</span> :- <label class="text-primary ts  mx-2"><b><?php echo $s["t_fname"] . " " . $s["t_lname"] ?></b></label>
                 | <span>Teacher Code</span> :- <label class="text-info ts mx-2"><b><?php echo $product["t_code"]  ?></b></label>
                  </div>
