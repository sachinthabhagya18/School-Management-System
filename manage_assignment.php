...
?>
  ...
  <head>
    ...
    <title>EASB Admin | Manage Assignments</title>
    <!-- plugins:css -->
              ...
              <div class="table-responsive row text-center">
                <div class="col-6">
                  <div class="row">
                    <div class="col-3 d-inline-block">
                      <select class="btn btn-sm  btn-outline-primary" id="basic_search_batch">
                        <option value="0">Select Batch</option>
                        <?php
                        $rs = Database::search("SELECT * FROM `batch`");
                        $n = $rs->num_rows;
                ...
                <table class="table">
                 ...
                 <input  type="button" value="Download Assignment"> -->
                        ...
                        <td><button class="badge badge-warning" onclick="sendid3(<?php echo $ir['a_id'] ?>);">Edit</button> |
                          <button class="badge badge-danger" onclick="deletemodel3(<?php echo $ir['a_id'] ?>);">Delete</button>
                        </td>
